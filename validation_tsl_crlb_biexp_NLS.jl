...
#LogRange(x1,x2,n) = round.(10^y for y in range(log10(x1), log10(x2), length=n))
#for s in SNRs
#    for n in N_TSLs
#        push!(param_args, tsl_params("biexp", n, "Non-Optimized", "Linear Spaced", "", s, round.(collect(LinRange(1e-6, 55.,n)'))));
#    end
#end
#for s in SNRs
#    for n in N_TSLs
#        push!(param_args, tsl_params("biexp", n, "Non-Optimized", "Log Spaced", "", s, LogRange(1e-6, 55. ,n)'));
#    end
#end
